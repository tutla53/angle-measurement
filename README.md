...
And also, the sensor installation may affect the stiffness of the robot, which is not desirable at the prototyping stage to get the optimum design of the robot.
